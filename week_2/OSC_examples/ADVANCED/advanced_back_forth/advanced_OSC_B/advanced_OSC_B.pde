// OSC Example 02: Two way Send <-> Receive (Side B)
...
void setup() {
    ...
    oscP5 = new OscP5(this, 5555); // New OSC object, listen on this port (remoteLocation on other side)
