// OSC Example: Two way Send <-> Receive (Side A)
...
void setup() {
  ...
  oscP5 = new OscP5(this, 5555); // Start OSC, receive messages on port 5555 (INPUT)
  remoteLocation = new NetAddress("127.0.0.1", 6666); // IP Address and listening port to send messages to. "127.0.0.1" means localhost ("use this computer")
}
